        ...
        return Ok(quote! {
            const _: () = {
                ...
                impl #impl_generics schemars::JsonSchema for #type_name #ty_generics #where_clause {
                    ...
                    fn json_schema(generator: &mut schemars::generator::SchemaGenerator) -> schemars::schema::Schema {
                        <#ty as schemars::JsonSchema>::json_schema(generator)
                    }

                    fn _schemars_private_non_optional_json_schema(generator: &mut schemars::generator::SchemaGenerator) -> schemars::schema::Schema {
